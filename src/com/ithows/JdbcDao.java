...
public class JdbcDao {
    ...
    public static Properties loadProperties() {
        ...
        try {
            ...
            if(OS.indexOf("win") >= 0){
//                fileName = JdbcDao.class.getResource("/").toString().replaceAll("file:/", "") + "connpool_etri.xml";  // -- @@ 윈도우즈 적용
...
//            }
    ...
    public static String queryForStringUTF(String sp_query, Object[] sp_Input) throws SQLException {
        Object obj = queryForObject(sp_query, sp_Input, null);
        if (obj == null) {
            return "";
        }
